...
function requestHttpWithBackoff(config, apiType, method, params) {
            ...
            try {
                ...
                switch (apiType) {
                    case AlchemyApiType.NFT:
                        response = yield sendAxiosRequest(config._getNftUrl(), method, params);
                        break;
                    default:
                    case AlchemyApiType.BASE:
                        response = yield sendAxiosRequest(config._getBaseUrl(), method, params);
                        break;
                }
 ...
 * @internal
 */
function paginateEndpoint(config, apiType, methodName, reqPageKey, resPageKey, params) {
    return __asyncGenerator(this, arguments, function* paginateEndpoint_1() {
        let hasNext = true;
        const requestParams = Object.assign({}, params);
        while (hasNext) {
            const response = yield __await(requestHttpWithBackoff(config, apiType, methodName, requestParams));
...
class NftNamespace {
     ...
     * @public
     */
    getNftMetadata(contractAddress, tokenId, tokenType) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getNFTMetadata', {
                contractAddress,
    ...
    getContractMetadata(contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getContractMetadata', {
                contractAddress
            });
    ...
    getNftsForOwnerIterator(owner, options) {
        return __asyncGenerator(this, arguments, function* getNftsForOwnerIterator_1() {
            ...
            try {
                for (var _b = __asyncValues(paginateEndpoint(this.config, AlchemyApiType.NFT, 'getNFTs', 'pageKey', 'pageKey', {
    ...
    getNftsForOwner(owner, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const withMetadata = omitMetadataToWithMetadata(options === null || options === void 0 ? void 0 : options.omitMetadata);
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getNFTs', {
                contractAddresses: options === null || options === void 0 ? void 0 : options.contractAddresses,
                pageKey: options === null || options === void 0 ? void 0 : options.pageKey,
                filters: options === null || options === void 0 ? void 0 : options.excludeFilters,
                owner,
    ...
    getNftsForContract(contractAddress, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const withMetadata = omitMetadataToWithMetadata(options === null || options === void 0 ? void 0 : options.omitMetadata);
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getNFTsForCollection', {
                contractAddress,
    ...
    getNftsForContractIterator(contractAddress, options) {
        return __asyncGenerator(this, arguments, function* getNftsForContractIterator_1() {
            ...
            const withMetadata = omitMetadataToWithMetadata(options === null || options === void 0 ? void 0 : options.omitMetadata);
            try {
                for (var _b = __asyncValues(paginateEndpoint(this.config, AlchemyApiType.NFT, 'getNFTsForCollection', 'startToken', 'nextToken', {
                    contractAddress,
                    startToken: options === null || options === void 0 ? void 0 : options.pageKey,
                    withMetadata
                })), _c; _c = yield __await(_b.next()), !_c.done;) {
    ...
    getOwnersForContract(contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getOwnersForCollection', {
                contractAddress
            });
            return {
    ...
    getOwnersForNft(contractAddress, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            return requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getOwnersForToken', {
                contractAddress,
                tokenId: bignumber.BigNumber.from(tokenId).toString()
            });
        });
    ...
    checkNftOwnership(owner, contractAddresses) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.getNftsForOwner(owner, {
                contractAddresses,
                omitMetadata: true
            });
    ...
    isSpamContract(contractAddress) {
        return requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'isSpamContract', {
            contractAddress
        });
    }
    /**
     ...
     */
    getSpamContracts() {
        return requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getSpamContracts', undefined);
    }
    /**
    ...
    getFloorPrice(contractAddress) {
        return requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'getFloorPrice', {
            contractAddress
        });
    }
    /**
    ...
    refreshNftMetadata(contractAddress, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const first = yield this.getNftMetadata(contractAddress, tokenIdString);
            const second = yield refresh(this.config, contractAddress, tokenIdString);
    ...
    refreshContract(contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield requestHttpWithBackoff(this.config, AlchemyApiType.NFT, 'reingestContract', {
                contractAddress
            });
            return {
...
function refresh(config, contractAddress, tokenId) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield requestHttpWithBackoff(config, AlchemyApiType.NFT, 'getNFTMetadata', {
            contractAddress,
            tokenId: bignumber.BigNumber.from(tokenId).toString(),
            refreshCache: true
        });
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-94833f65.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-1cf71959.js'); });
...
exports.toHex = toHex;
//# sourceMappingURL=index-04a23af4.js.map
