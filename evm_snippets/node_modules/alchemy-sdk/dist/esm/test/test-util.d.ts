...
import { RawBaseNft, RawContractBaseNft, RawBaseNftContract, RawNft, RawNftContract, RawOwnedBaseNft, RawOwnedNft } from '../src/internal/raw-interfaces';
...
export declare function createRawNft(title: string, tokenId: string, tokenType?: NftTokenType, tokenUri?: TokenUri, media?: TokenUri[] | undefined, timeLastUpdated?: string, description?: string | Array<string>): RawNft;
